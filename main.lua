...
guiElements = {
    ...
    {noLineBreak = true}, {label = "R", key = "bgColorR", value = 0, min = 0, max = 255, delta = 10, noLineBreak = true, integer = true},
    ...
    {noLineBreak = true}, {label = "R", key = "color1_r", value = 255, min = 0, max = 255, delta = 10, noLineBreak = true, integer = true, tooltip = "Red"},
    ...
    {noLineBreak = true}, {label = "dx", key = "areaSpreadX", value = 0, min = 0, delta = 10, noLineBreak = true,
    ...
    {noLineBreak = true}, {label = "max", key = "particleLifetimeMax", value = 1.0, min = 0, delta = 1, modDelta = 0.05, 
    ...
    {noLineBreak = true}, {label = "Size", key = "size1", value = 1.0, delta = 0.1, 
    ...
    {noLineBreak = true}, {label = "max", key = "rotationMax", value = 0, min = 0, max = 2*math.pi, delta = 0.1, 
            tooltip = "Sets the rotation of the image upon particle creation (in radians)"},
    {label = "Speed min", key = "speedMin", value = 400, delta = 10, 
            tooltip = "Sets the speed of the particles"},
    {noLineBreak = true}, {label = "max", key = "speedMax", value = 500, delta = 10, 
            tooltip = "Sets the speed of the particles"},
    {label = "Linear acceleration"},
    {noLineBreak = true}, {label = "x min", key = "linAccelXMin", value = 0, delta = 0.1, modDelta = 0.05, noLineBreak = true, 
    ...
    {label = "y min", key = "linAccelYMin", value = 0, delta = 0.1, modDelta = 0.05, 
            tooltip="Sets the linear acceleration (acceleration along the x and y axes) for particles"},
    {noLineBreak = true}, {label = "x max", key = "linAccelXMax", value = 0, delta = 0.1, modDelta = 0.05, noLineBreak = true, 
            tooltip = "Sets the linear acceleration (acceleration along the x and y axes) for particles"},
    ...
    {noLineBreak = true}, {label = "max", key = "radAccelMax", value = 0, delta = 0.1, modDelta = 0.05, 
            tooltip = "Set the radial acceleration (away from the emitter)"},
    ...
    {noLineBreak = true}, {label = "max", key = "tangAccelMax", value = 0, delta = 0.1, modDelta = 0.05, 
            tooltip = "Sets the tangential acceleration (acceleration perpendicular to the particle's direction)"},
    ...
    {noLineBreak = true}, {label = "max", key = "linDampMax", value = 0, delta = 0.1, modDelta = 0.05, 
            tooltip = "Sets the amount of linear damping (constant deceleration) for particles"},
    {label = "Spin min", key = "spinMin", value = 0, delta = 0.1, modDelta = 0.05, noLineBreak = true, 
            tooltip = "Sets the spin of the sprite"},
    {noLineBreak = true}, {label = "max", key = "spinMax", value = 0, delta = 0.1, modDelta = 0.05, 
            tooltip = "Sets the spin of the sprite"},
